...
$snippets[1]->fromArray(array(
    ...
    'snippet' => getSnippetContent($sources['source_core'].'/elements/snippets/snippet.churchevents_calendar.php'),
),'',true,true);
...
Use like: <ul>[[!churchEventsList? &limit=`20` ]]</ul>',
    'snippet' => getSnippetContent($sources['source_core'].'/elements/snippets/snippet.churchevents_list.php'),
),'',true,true);
