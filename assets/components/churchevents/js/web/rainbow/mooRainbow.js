...
var MooRainbow = new Class({
	...
	OverlayEvents: function() {
		...
		var temp = Array.clone(this.arrRGB);
		inputs = temp.concat(this.arrHSB, this.hexInput);
	...
	wheelEvents: function() {
		var temp = Array.clone(this.arrRGB);
		var arrColors = temp.extend(this.arrHSB);
	...
	doLayout: function() {
		...
		this.layout.slider = $$('#' + idPrefix + 'slider');
		...
		this.layout.cursor = $$('#' + idPrefix + 'cursor');
		this.layout.arrows = $$('#' + idPrefix + 'arrows');
		this.chooseColor = $$('#' + idPrefix + 'chooseColor');
		this.layout.backup = $$('#' + idPrefix + 'currentColor');
		this.RedInput = $$('#' + idPrefix + 'rInput');
		this.GreenInput = $$('#' + idPrefix + 'gInput');
		this.BlueInput = $$('#' + idPrefix + 'bInput');
		this.HueInput = $$('#' + idPrefix + 'HueInput');
		this.SatuInput = $$('#' + idPrefix + 'SatuInput');
		this.BrighInput = $$('#' + idPrefix + 'BrighInput');
		this.hexInput = $$('#' + idPrefix + 'hexInput');

		this.arrRGB = [this.RedInput, this.GreenInput, this.BlueInput];
		this.arrHSB = [this.HueInput, this.SatuInput, this.BrighInput];
		this.okButton = $$('#' + idPrefix + 'okButton');
